...
class FollowFormSharePost extends Component
{
    ...
    {
        $sharePost = \App\Models\Post::where('id', $this->postId)->first();
        return view('livewire.follow-form-share-post', compact('sharePost'));
    }
}
