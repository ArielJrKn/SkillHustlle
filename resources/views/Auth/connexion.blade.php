        ...
        <div class="w-full mx-auto p-3 absolute top-3 flex-col flex items-center justify-center h-full">
            <div class="lg:w-2/5 sm:w-full backdrop-filter backdrop-blur-3xl rounded-lg shadow-lg p-8 card">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-['Pacifico'] text-primary mb-2">Connexion</h1>
                    <div class="h-px bg-gray-200 my-4"></div>
                </div>
                
                <form id="registerForm" method="post" action="{{route('authLogin')}}" class="space-y-6">
                    @csrf
                    <div class="form-group flex items-center justify-between gap-2">
                        <div class="relative w-full">
                            ...
                            <input type="text" id="" name="email" class="form-control w-full px-10 py-3 border border-gray-300 rounded-button focus:outline-none bg-transparent " placeholder=" " required>
                            <label for="email" class="form-label text-gray-500 bg-transparent ml-4">Email</label>
                            @error('email')
                    ...
                    <div class="form-group flex items-center justify-between gap-2">
                        <div class="relative w-full">
                            ...
                            <input type="password" id="password" name="password" class="form-control w-full px-10 py-3 border border-gray-300 rounded-button focus:outline-none bg-transparent " placeholder=" " required>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="terms" name = "remember" class="mt-1">
