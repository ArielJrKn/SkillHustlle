                            ...
                            <div class="sm:w-full lg:w-3/5 h-96 flex justify-center items-center">
                               {{-- Form principal : update post --}}
                                <form class="MainForm bg-primary bg-opacity-20 rounded-md p-2 w-full flex-col" 
                                      method="post"
                                      action="{{ route('social.updateComment', $comment) }}" 
                                      enctype="multipart/form-data">

                                    @csrf
                                    @method('PUT')
                                    <div class="flex flex-col ">
                                        <h1 class="text-2xl font-semibold py-2">Modification de votre commentaire</h1>
                                        ...
                                        <div class="flex-1 flex-col text-gray-900 dark:text-gray-100 
                                            ...
                                            <textarea name="content"
                                                      ...
                                                      class="h-40 w-full flex-1 bg-transparent text-gray-900 dark:text-gray-100 px-4 py-3 m-0 text-sm">{{ $comment->content }}</textarea>
                                        </div>

                                        @php
                                            $commentMedia = $comment->medias->where('type', 'comment');
                                        @endphp
